...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("banner")
    .setDescription("Mostra o banner de um usuário ou o seu próprio.")
    .addUserOption((opt) =>
      opt
        .setName("usuario")
        .setDescription("O usuário que você quer ver o banner (opcional).")
        .setRequired(false)
    ),
  ...
  execute: async (interaction, client) => {
    try {
      ...
      console.warn(`[banner] Falha ao deferir: ${e.message}`);
      return;
    }
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setImage(bannerURL)
        .setDescription(`> Clique [aqui](${bannerURL}) para baixar a imagem.`);
