...
module.exports = {
  name: "banner",
  description: "Mostra o banner de um usuário ou o seu próprio.",
  ...
  execute: async (message, args, client) => {
    ...
    try {
      ...
      try {
        ...
        console.error("Erro ao buscar usuário no .banner:", err);
        return responseMsg
          .edit({
            embeds: [
              new EmbedBuilder()
      ...
      const embed = new EmbedBuilder()
        ...
        .setImage(bannerURL)
        .setDescription(`> [Clique aqui para baixar a imagem.](${bannerURL})`);

      await responseMsg.edit({ embeds: [embed], content: "" });
    } catch (err) {
      if (err.code === 10013 || err.code === 50013) {
